...
import MyCourseEndpointPage from '~/components/education/MyCourseEndpointPage.vue'
import { useEducationNavigation } from '~/composables/useEducationNavigation'

definePageMeta({
  layout: 'default',
  title: 'pages.education.myCourses.endpoints.export',
...
<template>
  <v-container fluid>
    ...
    <MyCourseEndpointPage slug="exporter-mon-historique" />
  </v-container>
</template>
