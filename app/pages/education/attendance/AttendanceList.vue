...
import AttendanceTable from '../../../components/education/attendance/AttendanceTable.vue'
  ...
  try {
    ...
    if (readonly.value) {
      attendanceList = attendanceList.filter(
        (i) => (i.resourceLinkListFromEntity?.[0]?.visibility || 0) === 2,
      )
    }
