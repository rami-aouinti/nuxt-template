      ...
      <div class="flex flex-row mb-2">
        ...
        <BaseRadioButtons
          ...
          :options="[
            ...
            {
              label: t('Rename the uploaded file if it exists'),
              value: 'rename',
            },
          ]"
...
import BaseAdvancedSettingsButton from '../../../components/education/basecomponents/BaseAdvancedSettingsButton.vue'
...
const parentResourceNodeId = ref(
  Number(route.query.parentResourceNodeId || route.params.node),
)
