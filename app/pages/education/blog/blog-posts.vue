...
import CalendarMini from '../../../components/education/blog/CalendarMini.vue'
import MyTasksPanel from '../../../components/education/blog/MyTasksPanel.vue'
import PostCreateDialog from '../../../components/education/blog/PostCreateDialog.vue'
import TaskCreateDialog from '../../../components/education/blog/TaskCreateDialog.vue'
...
async function reloadAssignments() {
  ...
  try {
    ...
    if (
      typeof service.listMyAssignments === 'function' &&
      ...
      assignments.value = await service.listAssignments({
        blogId,
        sessionId: sid,
      })
    }
