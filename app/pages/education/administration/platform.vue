...
import AdminCategoryEndpoints from '~/components/education/AdminCategoryEndpoints.vue'
import { useEducationNavigation } from '~/composables/useEducationNavigation'

definePageMeta({
  layout: 'default',
  title: 'pages.education.administration.categories.platform.title',
  icon: 'mdi-web-sync',
  drawerIndex: 3,
})
...
<template>
  <v-container fluid>
    ...
    <AdminCategoryEndpoints category-key="platform" />
  </v-container>
</template>
