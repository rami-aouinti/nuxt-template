  ...
  <div class="invite-friends-container invite-friends">
      ...
      <div class="friends-list">
        ...
        <div class="list-content">
          ...
          >
            ...
            <button class="invite-btn" @click="selectFriend(friend)">+</button>
          </div>
        </div>
      </div>
      <div class="selected-friends-list">
        ...
        <div class="list-content">
          ...
          >
            ...
            <button class="remove-btn" @click="removeFriend(friend)">-</button>
          </div>
        </div>
      </div>
    </div>
    <div class="invite-friends-footer">
      <button class="send-invites-btn" @click="sendInvitations">
        {{ t('Sent invitations') }}
      </button>
    </div>
    <div class="invited-friends-list mt-4">
      ...
      <div class="invited-users-grid mt-4">
        <div v-for="user in invitedFriends" :key="user.id" class="user-card">
...
const loadAvailableFriends = async () => {
  ...
  try {
    const response = await axios.get(
      `/social-network/invite-friends/${userId}/${groupId}`,
    )
...
const loadInvitedFriends = async () => {
  ...
  try {
    const response = await axios.get(
      `/social-network/group/${groupId}/invited-users`,
    )
