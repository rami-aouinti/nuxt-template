...
import BaseInputTextWithVuelidate from '../../../components/education/basecomponents/BaseInputTextWithVuelidate.vue'
...
const createGroup = async () => {
  ...
  if (!v$.value.$invalid) {
    ...
    try {
      ...
      console.error(
        'Failed to create group or upload picture:',
        error.response.data,
      )
    }
  }
...
const updateGroupsList = () => {
  ...
  usergroupService
    .listPopular()
    .then((popular) => (popularGroups.value = popular))
