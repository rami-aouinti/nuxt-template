      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
        <div>
          ...
          <BaseInputText
            ...
            label=""
          />
          <small v-if="submitted && !form.url" class="text-red-500">
            {{ t('URL is required') }}
          </small>
        </div>
        ...
        <div class="md:col-span-2">
          ...
          <div v-if="loadingTemplates" class="text-gray-600">
            {{ t('Loading templates...') }}
          </div>
...
import PageLayoutEditor from '../../../components/education/pageLayout/PageLayoutEditor.vue'
...
async function saveLayout() {
  ...
  try {
    await pageService.updatePageLayout(
      `/api/page_layouts/${route.params.id}`,
      payload,
    )
