<template>
  <div v-if="isLoadingBlocks" class="admin-index">
    <Skeleton
      v-for="i in 9"
      :key="`skeleton-${i}`"
      height="30rem"
  ...
  <div v-else class="admin-index">
    ...
    <AdminBlock
      ...
      :description="
        t('Here you can manage registered users within your platform')
      "
    ...
    <AdminBlock
      ...
      :description="
        t('Create course packages for a certain time with training sessions')
      "
    ...
    <AdminBlock
      ...
      :description="
        t('Manage the skills of your users, through courses and badges')
      "
    ...
    <AdminBlock
      ...
      :description="
        t('View the status of your server, perform performance tests')
      "
    ...
    <AdminBlock
      ...
      :description="
        t('Learn more about Chamilo and its use, official references links')
      "
    ...
    >
      <div class="admin-index__block">
        ...
        />
        <div v-else class="block-admin-version__form">
          <i18n-t
            class="mb-3"
    ...
    >
      <div class="admin-index__block">
        ...
        />
        <div v-else class="block-admin-news__status">
          <i18n-t class="mb-3" keypath="Disabled" tag="p" />
        </div>
      </div>
    </div>
    ...
    >
      <div class="admin-index__block">
        ...
        />
        <div v-else v-t="'Disabled'" class="block-admin-news__status" />
      </div>
    </div>
  </div>
</template>
