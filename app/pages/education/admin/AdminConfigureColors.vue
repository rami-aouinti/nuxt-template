<template>
  <div id="top" class="admin-colors scroll-mt-24">
    <SectionHeader :title="t('Configure Chamilo colors')" />

    <div
      class="sticky top-0 z-10 bg-white/75 backdrop-blur-sm border-b border-gray-100 shadow-sm py-2 mb-6"
    >
    ...
    <div id="colors" class="admin-colors__container">
    ...
    <div id="branding" class="mt-10 scroll-mt-24">
      ...
      <p class="text-sm opacity-80 mb-4">
        ...
        {{
          t(
            'Switch the active theme if you want to upload logos for a different one.',
          )
        }}
      </p>
...
import ColorThemePreview from '../../../components/education/admin/ColorThemePreview.vue'
import ColorThemeForm from '../../../components/education/admin/ColorThemeForm.vue'
