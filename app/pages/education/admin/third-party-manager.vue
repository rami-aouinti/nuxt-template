<template>
  <div>
    ...
    <BaseTable :is-loading="loading" :values="thirdParties" data-key="id">
      ...
      <form @submit.prevent="submitThirdParty">
        <div class="p-fluid space-y-4">
          ...
          <div class="p-field">
            ...
            <InputText id="address" v-model.trim="form.address" />
          </div>
...
const validateWebsite = () => {
  ...
  if (!isValidHttpUrl(candidate)) {
    errors.value.website = t(
      'This is not a valid URL. Example: https://example.com',
    )
    return false
  }
  return true
