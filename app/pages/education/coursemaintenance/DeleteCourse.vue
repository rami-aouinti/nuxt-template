  ...
  <div class="space-y-6">
    ...
    <section class="rounded-lg border border-rose-200 bg-rose-50 p-4">
      ...
      <p class="mb-3 text-sm text-rose-800">
        {{
          t(
            'Type the course code to confirm. All data will be permanently removed.',
          )
        }}
      </p>
      ...
      <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div>
          ...
          <div class="mt-3 flex items-start gap-2 text-xs text-rose-900">
            ...
            />
            <label for="delete-docs" class="select-none">
              {{
                t(
                  'Also delete documents that are only used in this course (if any).',
                )
              }}
...
const canDelete = computed(
  () => !!confirmText.value && confirmText.value === courseCode.value,
)
