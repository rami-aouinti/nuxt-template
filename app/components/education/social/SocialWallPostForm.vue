...
import {
  SOCIAL_TYPE_PROMOTED_MESSAGE,
  SOCIAL_TYPE_WALL_POST,
} from './constants.js'
...
function showCheckboxPromoted() {
  allowCreatePromoted.value =
    securityStore.isAdmin && securityStore.user['@id'] === user.value['@id']
}
