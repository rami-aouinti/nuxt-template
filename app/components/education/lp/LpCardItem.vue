...
<template>
  ...
  >
    ...
    <div
      class="mt-2 grid grid-cols-[80px_1fr] gap-3 items-start md:pr-10 sm:ml-8 ml-5 mr-2 md:mr-0"
    >
      <div
        class="w-20 h-20 rounded-xl overflow-hidden ring-1 ring-gray-25 bg-gray-15 shrink-0 ml-2 sm:ml-0"
      >
        <img
          v-if="lp.coverUrl"
          :src="lp.coverUrl"
      ...
      <div class="min-w-0 flex ml-2 md:ml-0">
        <div class="flex-1">
          <h3
            class="font-semibold text-gray-90 leading-none md:truncate text-lg md:text-xl leading-none"
          >
            <button
    ...
    <div
      class="mt-auto pt-3 flex items-center ml-5 pl-2 sm:ml-8 sm:pl-0 mr-2 md:mr-0"
    >
