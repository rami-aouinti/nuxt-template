...
const displayTitle = computed(
  () => props.title || t('Learning path categories'),
)
...
const storageKey = computed(
  () => `lpCatOpen:${props.category?.iid || props.title}`,
)
onMounted(() => {
...
const panelId = computed(
  () => `cat-panel-${props.category?.iid || props.title}`,
)
const toggleOpen = () => {
...
<template>
  <section class="relative ml-2 rounded-2xl shadow-lg">
    <header
      class="relative bg-support-6 rounded-t-2xl flex items-center justify-between pl-0 pr-4 py-3"
    >
      <span
      ...
      <div class="flex items-center gap-3">
        ...
        <template v-else>
          <span class="inline-block w-8 h-8" aria-hidden />
        </template>
      ...
      <div class="flex items-center gap-2">
        <div class="text-tiny text-gray-50">
        ...
        >
          ...
          <template #menu>
            ...
            >
              ...
              <div class="my-1 h-px bg-gray-15" />
              <button
                class="w-full text-left px-3 py-2 rounded hover:bg-gray-15"
