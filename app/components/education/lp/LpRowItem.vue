...
const progressBgClass = computed(() => {
  return props.ringValue(props.lp.progress) === 100
    ? 'bg-success'
    : 'bg-support-5'
})
...
<template>
  ...
  >
    ...
    <div class="flex gap-4 w-full">
      <div
        class="ml-5 w-20 h-20 md:w-24 md:h-24 rounded-xl overflow-hidden ring-1 ring-gray-25 bg-gray-15 shrink-0"
      >
        <img
          v-if="lp.coverUrl"
          :src="lp.coverUrl"
      ...
      <div class="flex-1 min-w-0 md:flex md:flex-col md:justify-center">
        <h3
          class="font-semibold text-gray-90 md:truncate text-lg md:text-2xl leading-none"
        >
          <button
        ...
        >
          <span class="text-support-5 font-medium">{{
            t('Prerequisites')
          }}</span>
      ...
      >
        ...
        <template #menu>
          <div
            class="absolute right-0 z-50 w-52 bg-white border border-gray-25 rounded-xl shadow-xl p-1"
          >
            <button
    ...
    <template v-if="canEdit">
      <div
        class="ml-5 md:ml-auto md:flex-col flex items-end justify-between md:justify-start"
      >
        ...
        <div
          class="row-start-2 col-start-1 col-end-5 flex items-center gap-2 justify-self-end mt-5 order-1 md:order-2"
        >
          ...
          <div class="relative w-10 h-10 order-1 md:order-2">
            ...
            />
            <div
              class="absolute inset-0 grid place-content-center text-tiny font-semibold text-gray-90"
            >
