<template>
  <form>
    ...
    <div class="m-4 flex flex-col gap-2">
      <label for="color-picker" class="font-semibold text-sm">
        {{ t('Color') }}
      </label>
      <input
        id="color-picker"
    ...
    <CalendarRemindersEditor v-if="!isGlobal" v-model="item" />
...
function getContextTypeFromRoute() {
  ...
  if (route.query.cid && (!route.query.sid || route.query.sid === '0'))
    return 'course'
  return 'personal'
}
