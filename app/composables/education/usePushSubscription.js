...
export function usePushSubscription() {
  ...
  function loadVapidKey() {
    ...
    const rawSettings = platformConfigStore.getSetting(
  ...
  async function checkSubscription(userId) {
    ...
    try {
      ...
      if (!registration) {
        console.warn(
          '[Push] Could not register Service Worker. Skipping subscription check.',
        )
        loading.value = false
        return false
      }
  ...
  async function subscribe(userId) {
    ...
    try {
      ...
      if (!registration) {
        console.warn(
          '[Push] Could not register Service Worker. Cannot subscribe.',
        )
        loading.value = false
        return false
      }
  ...
  async function unsubscribe(userId) {
    ...
    try {
      ...
      if (!registration) {
        console.warn(
          '[Push] Could not register Service Worker. Cannot unsubscribe.',
        )
        loading.value = false
        return false
      }
