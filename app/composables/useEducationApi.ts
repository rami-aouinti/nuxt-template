  ...
  const educationApi = {
    ...
    accessUrls: {
      ...
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/access_urls/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/access_urls/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/access_urls/${encode(id)}`, { method: 'PATCH', body: payload }),
    ...
    accessUrlRelColorThemes: {
      ...
      create: <T>(payload: RequestBody) =>
        request<T>('/access_url_rel_color_themes', { method: 'POST', body: payload }),
    },
    accessUrlRelUsers: {
      list: <T>() => request<T>('/access_url_rel_users'),
      create: <T>(payload: RequestBody) =>
        request<T>('/access_url_rel_users', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/access_url_rel_users/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
      ...
      delete: (id: string | number) =>
        request<undefined>(`/access_url_rel_users/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/access_url_rel_users/${encode(id)}`, {
          method: 'PATCH',
          body: payload,
    ...
    attendances: {
      ...
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/attendances/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
      ...
      toggleVisibility: <T>(id: string | number) =>
        request<T>(`/attendances/${encode(id)}/toggle_visibility`, { method: 'PUT' }),
    },
    attendanceCalendars: {
      list: <T>() => request<T>('/c_attendance_calendars'),
      create: <T>(payload: RequestBody) =>
        request<T>('/c_attendance_calendars', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/c_attendance_calendars/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
    ...
    blogs: {
      ...
      create: <T>(payload: RequestBody) => request<T>('/c_blogs', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/c_blogs/${encode(id)}`),
      delete: (id: string | number) =>
        request<undefined>(`/c_blogs/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/c_blogs/${encode(id)}`, { method: 'PATCH', body: payload }),
      toggleVisibility: <T>(id: string | number) =>
        request<T>(`/c_blogs/${encode(id)}/toggle_visibility`, { method: 'PUT' }),
    },
    blogAttachments: {
      ...
      upload: <T>(payload: RequestBody) =>
        request<T>('/c_blog_attachments/upload', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/c_blog_attachments/${encode(id)}`),
    },
    blogComments: {
      list: <T>() => request<T>('/c_blog_comments'),
      create: <T>(payload: RequestBody) =>
        request<T>('/c_blog_comments', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/c_blog_comments/${encode(id)}`),
      delete: (id: string | number) =>
        request<undefined>(`/c_blog_comments/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/c_blog_comments/${encode(id)}`, { method: 'PATCH', body: payload }),
    },
    blogPosts: {
      list: <T>() => request<T>('/c_blog_posts'),
      create: <T>(payload: RequestBody) =>
        request<T>('/c_blog_posts', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/c_blog_posts/${encode(id)}`),
      delete: (id: string | number) =>
        request<undefined>(`/c_blog_posts/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/c_blog_posts/${encode(id)}`, { method: 'PATCH', body: payload }),
    },
    blogRatings: {
      list: <T>() => request<T>('/c_blog_ratings'),
      create: <T>(payload: RequestBody) =>
        request<T>('/c_blog_ratings', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/c_blog_ratings/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/c_blog_ratings/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/c_blog_ratings/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/c_blog_ratings/${encode(id)}`, { method: 'PATCH', body: payload }),
    },
    blogRelUsers: {
      ...
      delete: (id: string | number) =>
        request<undefined>(`/c_blog_rel_users/${encode(id)}`, { method: 'DELETE' }),
    },
    blogTasks: {
      list: <T>() => request<T>('/c_blog_tasks'),
      create: <T>(payload: RequestBody) =>
        request<T>('/c_blog_tasks', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/c_blog_tasks/${encode(id)}`),
      delete: (id: string | number) =>
        request<undefined>(`/c_blog_tasks/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/c_blog_tasks/${encode(id)}`, { method: 'PATCH', body: payload }),
    },
    blogTaskRelUsers: {
      list: <T>() => request<T>('/c_blog_task_rel_users'),
      create: <T>(payload: RequestBody) =>
        request<T>('/c_blog_task_rel_users', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/c_blog_task_rel_users/${encode(id)}`),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/c_blog_task_rel_users/${encode(id)}`, { method: 'PATCH', body: payload }),
    },
    calendarEvents: {
      list: <T>() => request<T>('/c_calendar_events'),
      create: <T>(payload: RequestBody) =>
        request<T>('/c_calendar_events', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/c_calendar_events/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/c_calendar_events/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/c_calendar_events/${encode(id)}`, { method: 'DELETE' }),
    },
    dropboxFiles: {
      upload: <T>(payload: RequestBody) =>
        request<T>('/c_dropbox_files/upload', { method: 'POST', body: payload }),
    },
    studentPublications: {
      list: <T>() => request<T>('/c_student_publications'),
      create: <T>(payload: RequestBody) =>
        request<T>('/c_student_publications', { method: 'POST', body: payload }),
      upload: <T>(payload: RequestBody) =>
        request<T>('/c_student_publications/upload', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/c_student_publications/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
      ...
      delete: (id: string | number) =>
        request<undefined>(`/c_student_publications/${encode(id)}`, { method: 'DELETE' }),
    },
    ...
    studentPublicationComments: {
      ...
      upload: <T>(payload: RequestBody) =>
        request<T>('/c_student_publication_comments/upload', { method: 'POST', body: payload }),
    },
    ...
    studentPublicationRelDocuments: {
      ...
      create: <T>(payload: RequestBody) =>
        request<T>('/c_student_publication_rel_documents', { method: 'POST', body: payload }),
      get: <T>(id: string | number) =>
        request<T>(`/c_student_publication_rel_documents/${encode(id)}`),
      delete: (id: string | number) =>
        request<undefined>(`/c_student_publication_rel_documents/${encode(id)}`, {
          method: 'DELETE',
        }),
    },
    studentPublicationRelUsers: {
      ...
      create: <T>(payload: RequestBody) =>
        request<T>('/c_student_publication_rel_users', { method: 'POST', body: payload }),
      get: <T>(id: string | number) =>
    ...
    toolIntros: {
      ...
      get: <T>(id: string | number) => request<T>(`/c_tool_intros/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/c_tool_intros/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/c_tool_intros/${encode(id)}`, { method: 'DELETE' }),
    },
    ...
    colorThemes: {
      ...
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/color_themes/${encode(id)}`, { method: 'PUT', body: payload }),
    },
    conferenceActivities: {
      callback: <T>(payload: RequestBody) =>
        request<T>('/videoconference/callback', { method: 'POST', body: payload }),
    },
    courses: {
    ...
    courseCategories: {
      ...
      get: <T>(id: string | number) => request<T>(`/course_categories/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/course_categories/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/course_categories/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/course_categories/${encode(id)}`, { method: 'PATCH', body: payload }),
    ...
    courseRelUsers: {
      ...
      get: <T>(id: string | number) => request<T>(`/course_rel_users/${encode(id)}`),
    },
    documents: {
      ...
      downloadSelected: <T>(payload: RequestBody) =>
        request<T>('/documents/download-selected', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/documents/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/documents/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
      ...
      move: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/documents/${encode(id)}/move`, { method: 'PUT', body: payload }),
      replaceFile: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/documents/${encode(id)}/replace`, { method: 'POST', body: payload }),
      toggleVisibility: <T>(id: string | number) =>
        request<T>(`/documents/${encode(id)}/toggle_visibility`, { method: 'PUT' }),
    },
    extraFields: {
      list: <T>() => request<T>('/extra_fields'),
      create: <T>(payload: RequestBody) =>
        request<T>('/extra_fields', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/extra_fields/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/extra_fields/${encode(id)}`, { method: 'PUT', body: payload }),
    },
    extraFieldValues: {
      list: <T>() => request<T>('/extra_field_valuess'),
      create: <T>(payload: RequestBody) =>
        request<T>('/extra_field_valuess', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/extra_field_valuess/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/extra_field_valuess/${encode(id)}`, { method: 'PUT', body: payload }),
    },
    glossaries: {
      ...
      exportToDocuments: <T>(payload: RequestBody) =>
        request<T>('/glossaries/export_to_documents', { method: 'POST', body: payload }),
      ...
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/glossaries/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
    ...
    gradebookCategories: {
      ...
      get: <T>(id: string | number) => request<T>(`/gradebook_categories/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/gradebook_categories/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/gradebook_categories/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/gradebook_categories/${encode(id)}`, { method: 'PATCH', body: payload }),
    },
    groups: {
    ...
    illustrations: {
      ...
      get: <T>(id: string | number) => request<T>(`/illustrations/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/illustrations/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/illustrations/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/illustrations/${encode(id)}`, { method: 'PATCH', body: payload }),
    },
    languages: {
      ...
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/languages/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/languages/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/languages/${encode(id)}`, { method: 'PATCH', body: payload }),
    },
    learningPaths: {
      list: <T>() => request<T>('/learning_paths'),
      reorder: <T>(payload: RequestBody) =>
        request<T>('/learning_paths/reorder', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/learning_paths/${encode(id)}`),
    },
    ...
    legals: {
      ...
      create: <T>(payload: RequestBody) => request<T>('/legals', { method: 'POST', body: payload }),
    ...
    links: {
      ...
      create: <T>(payload: RequestBody) => request<T>('/links', { method: 'POST', body: payload }),
      ...
      check: <T>(id: string | number) => request<T>(`/links/${encode(id)}/check`),
      details: <T>(id: string | number) => request<T>(`/links/${encode(id)}/details`),
      move: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/links/${encode(id)}/move`, { method: 'PUT', body: payload }),
      toggleVisibility: <T>(id: string | number) =>
        request<T>(`/links/${encode(id)}/toggle_visibility`, { method: 'PUT' }),
      uploadImage: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/links/${encode(id)}/upload-image`, { method: 'POST', body: payload }),
    },
    linkCategories: {
      list: <T>() => request<T>('/link_categories'),
      create: <T>(payload: RequestBody) =>
        request<T>('/link_categories', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/link_categories/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/link_categories/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/link_categories/${encode(id)}`, { method: 'DELETE' }),
      toggleVisibility: <T>(id: string | number) =>
        request<T>(`/link_categories/${encode(id)}/toggle_visibility`, { method: 'PUT' }),
    },
    authentication: {
    ...
    messages: {
      ...
      create: <T>(payload: RequestBody) => request<T>('/messages', { method: 'POST', body: payload }),
    ...
    messageAttachments: {
      get: <T>(id: string | number) => request<T>(`/message_attachments/${encode(id)}`),
    },
    messageRelUsers: {
      get: <T>(id: string | number) => request<T>(`/message_rel_users/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/message_rel_users/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/message_rel_users/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/message_rel_users/${encode(id)}`, { method: 'PATCH', body: payload }),
    },
    messageTags: {
      list: <T>() => request<T>('/message_tags'),
      create: <T>(payload: RequestBody) =>
        request<T>('/message_tags', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/message_tags/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/message_tags/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/message_tags/${encode(id)}`, { method: 'DELETE' }),
    },
    pages: {
      list: <T>() => request<T>('/pages'),
      create: <T>(payload: RequestBody) => request<T>('/pages', { method: 'POST', body: payload }),
    ...
    pageCategories: {
      ...
      get: <T>(id: string | number) => request<T>(`/page_categories/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/page_categories/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/page_categories/${encode(id)}`, { method: 'DELETE' }),
    },
    pageLayouts: {
      list: <T>() => request<T>('/page_layouts'),
      create: <T>(payload: RequestBody) =>
        request<T>('/page_layouts', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/page_layouts/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/page_layouts/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/page_layouts/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/page_layouts/${encode(id)}`, { method: 'PATCH', body: payload }),
    },
    pageLayoutTemplates: {
      list: <T>() => request<T>('/page_layout_templates'),
      create: <T>(payload: RequestBody) =>
        request<T>('/page_layout_templates', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/page_layout_templates/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/page_layout_templates/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/page_layout_templates/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/page_layout_templates/${encode(id)}`, { method: 'PATCH', body: payload }),
    },
    personalFiles: {
      list: <T>() => request<T>('/personal_files'),
      create: <T>(payload: RequestBody) =>
        request<T>('/personal_files', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/personal_files/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/personal_files/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/personal_files/${encode(id)}`, { method: 'DELETE' }),
    },
    pushSubscriptions: {
      list: <T>() => request<T>('/push_subscriptions'),
      create: <T>(payload: RequestBody) =>
        request<T>('/push_subscriptions', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/push_subscriptions/${encode(id)}`),
      delete: (id: string | number) =>
        request<undefined>(`/push_subscriptions/${encode(id)}`, { method: 'DELETE' }),
    },
    resourceFiles: {
      ...
      addVariant: <T>(payload: RequestBody) =>
        request<T>('/resource_files/add_variant', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/resource_files/${encode(id)}`),
    },
    resourceLinks: {
      list: <T>() => request<T>('/resource_links'),
      create: <T>(payload: RequestBody) =>
        request<T>('/resource_links', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/resource_links/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/resource_links/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/resource_links/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/resource_links/${encode(id)}`, { method: 'PATCH', body: payload }),
    },
    resourceNodes: {
      list: <T>() => request<T>('/resource_nodes'),
      get: <T>(id: string | number) => request<T>(`/resource_nodes/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/resource_nodes/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/resource_nodes/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/resource_nodes/${encode(id)}`, { method: 'PATCH', body: payload }),
    },
    sessions: {
    ...
    sessionCategories: {
      ...
      get: <T>(id: string | number) => request<T>(`/session_categories/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/session_categories/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/session_categories/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/session_categories/${encode(id)}`, { method: 'PATCH', body: payload }),
    },
    sessionRelCourses: {
      list: <T>() => request<T>('/session_rel_courses'),
      create: <T>(payload: RequestBody) =>
        request<T>('/session_rel_courses', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/session_rel_courses/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/session_rel_courses/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/session_rel_courses/${encode(id)}`, { method: 'DELETE' }),
    },
    sessionRelCourseRelUsers: {
      list: <T>() => request<T>('/session_rel_course_rel_users'),
      create: <T>(payload: RequestBody) =>
        request<T>('/session_rel_course_rel_users', { method: 'POST', body: payload }),
      get: <T>(id: string | number) =>
    ...
    sessionRelUsers: {
      ...
      get: <T>(id: string | number) => request<T>(`/session_rel_users/${encode(id)}`),
    },
    skills: {
      list: <T>() => request<T>('/skills'),
      create: <T>(payload: RequestBody) => request<T>('/skills', { method: 'POST', body: payload }),
    ...
    skillProfiles: {
      ...
      get: <T>(id: string | number) => request<T>(`/skill_profiles/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/skill_profiles/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/skill_profiles/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/skill_profiles/${encode(id)}`, { method: 'PATCH', body: payload }),
    },
    skillRelUsers: {
      create: <T>(payload: RequestBody) =>
        request<T>('/skill_rel_users', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/skill_rel_users/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/skill_rel_users/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/skill_rel_users/${encode(id)}`, { method: 'DELETE' }),
    },
    socialPosts: {
      list: <T>() => request<T>('/social_posts'),
      create: <T>(payload: RequestBody) =>
        request<T>('/social_posts', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/social_posts/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/social_posts/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
    ...
    socialPostAttachments: {
      ...
      create: <T>(payload: RequestBody) =>
        request<T>('/social_post_attachments', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/social_post_attachments/${encode(id)}`),
    },
    thirdParties: {
      list: <T>() => request<T>('/third_parties'),
      create: <T>(payload: RequestBody) =>
        request<T>('/third_parties', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/third_parties/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/third_parties/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/third_parties/${encode(id)}`, { method: 'DELETE' }),
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/third_parties/${encode(id)}`, { method: 'PATCH', body: payload }),
    },
    thirdPartyDataExchanges: {
      list: <T>() => request<T>('/third_party_data_exchanges'),
      create: <T>(payload: RequestBody) =>
        request<T>('/third_party_data_exchanges', { method: 'POST', body: payload }),
      get: <T>(id: string | number) =>
        request<T>(`/third_party_data_exchanges/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/third_party_data_exchanges/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
    ...
    thirdPartyDataExchangeUsers: {
      ...
      create: <T>(payload: RequestBody) =>
        request<T>('/third_party_data_exchange_users', { method: 'POST', body: payload }),
      get: <T>(id: string | number) =>
    ...
    trackEAttempts: {
      ...
      get: <T>(id: string | number) => request<T>(`/track_e_attempts/${encode(id)}`),
    },
    ...
    users: {
      createForAccessUrl: <T>(accessUrlId: string | number, payload: RequestBody) =>
        request<T>(`/access_urls/${encode(accessUrlId)}/user`, { method: 'POST', body: payload }),
      list: <T>() => request<T>('/users'),
      create: <T>(payload: RequestBody) => request<T>('/users', { method: 'POST', body: payload }),
      ...
      courseStats: <T>(id: string | number, courseId: string | number, metric: string) =>
        request<T>(`/users/${encode(id)}/courses/${encode(courseId)}/stats/${encode(metric)}`),
      skills: <T>(id: string | number) => request<T>(`/users/${encode(id)}/skills`),
    },
    userRelCourseVotes: {
      list: <T>() => request<T>('/user_rel_course_votes'),
      create: <T>(payload: RequestBody) =>
        request<T>('/user_rel_course_votes', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/user_rel_course_votes/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/user_rel_course_votes/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/user_rel_course_votes/${encode(id)}`, { method: 'DELETE' }),
    },
    userRelUsers: {
      list: <T>() => request<T>('/user_rel_users'),
      create: <T>(payload: RequestBody) =>
        request<T>('/user_rel_users', { method: 'POST', body: payload }),
      get: <T>(id: string | number) => request<T>(`/user_rel_users/${encode(id)}`),
      replace: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/user_rel_users/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/user_rel_users/${encode(id)}`, { method: 'DELETE' }),
    },
    usergroups: {
      ...
      update: <T>(id: string | number, payload: RequestBody) =>
        request<T>(`/usergroups/${encode(id)}`, { method: 'PUT', body: payload }),
      delete: (id: string | number) =>
        request<undefined>(`/usergroups/${encode(id)}`, { method: 'DELETE' }),
      members: <T>(id: string | number) => request<T>(`/usergroups/${encode(id)}/members`),
    },
  }
